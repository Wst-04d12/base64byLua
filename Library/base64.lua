----------------------------------------------
--The initial codes are from gamesense, Copyright gamesense.pub
--Modified and improved by wst.
----------------------------------------------
...
function M.decode(b64, decoder)
	...
	local b64_length = string.len(b64)
	for i = 1, math.fmod(b64_length, 4) do
		b64 = b64 .. "="
	end
	...
	for i = 1, padding > 0 and n-4 or n, 4 do
		...
		--fix
			if c == nil then
				print("The base64 string you gave is not standard or contains some syntax error, please check.")
				os.execute("pause")
			end
		--endfix
